...
export const TYPES = {
  ...
  StripeWebhookEventRepository: Symbol.for('StripeWebhookEventRepository'),
  ...
  PasswordStrengthService: Symbol.for('PasswordStrengthService'),
  ...
  StripeClientService: Symbol.for('StripeClientService'),
